...
// Կա նաև այսպիսի string

var newStr = `Inch vor text`;
// սա յուրահատուկ է նրանով, որ կարող ես այս string-ի մեջ դնել փոփոխական, կոչվում է template string
var template = 'template';
var mar = `This is a ${template} string`;
